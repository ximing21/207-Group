...
public class AddProjectUseCaseFactory {
    ...
    public static AddProjectView create(ViewManagerModel viewManagerModel,
        ...
        DeleteProjectController deleteProjectController = createDeleteProjectUseCase(viewManagerModel, deleteProjectViewModel, userDataAccessObject);
        return new AddProjectView(addProjectViewModel, addProjectController, addedProjectViewModel, getProjectViewModel, getProjectController, getTaskController, deleteProjectController, deleteProjectViewModel);
    }
    ...
    private static DeleteProjectController createDeleteProjectUseCase(ViewManagerModel viewManagerModel,
                                                                      DeleteProjectViewModel deleteProjectViewModel,
                                                                      DeleteProjectDataAccessInterface userDataAccessObject) {
        DeleteProjectOutputBoundary deleteProjectOutputBoundary = new DeleteProjectPresenter(deleteProjectViewModel, viewManagerModel);
        DeleteProjectInputBoundary deleteProjectInteractor = new DeleteProjectInteractor(deleteProjectOutputBoundary, userDataAccessObject);
